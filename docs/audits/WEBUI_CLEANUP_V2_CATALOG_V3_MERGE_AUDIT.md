...
- largest files:
  - `web-ui/src/ui/app.ts`: 77892 bytes.
  - `web-ui/src/ui/canvas/dragInsert.ts`: 19133 bytes.
  - `web-ui/src/ui/editor/formControls.ts`: 17135 bytes.
  - `src/main/java/com/pixelmc/pixellogic/core/catalog/BuiltInBlockCatalog.java`: 40169 bytes.
  - `src/main/java/com/pixelmc/pixellogic/core/graph/GraphValidator.java`: 21901 bytes.
  - `src/main/java/com/pixelmc/pixellogic/core/simulation/executor/SimulationExecutionRegistry.java`: 21524 bytes.
