import type { GraphDocument, GraphEdge, GraphNode } from '../../model/graphTypes';
...
export function renderNodeInfo(nodeItem: GraphNode, graph: GraphDocument, selectedNodeId: string): string {
